		...
		<c:forEach items="${pessoa}" var="p">
			<tr>
				...
				<td>${p.nome}</td>
             	...
             	<td>
                <a href="admindelete?matricula=${p.matricula}">Remover</a>
             	</td>
			</tr>	
		</c:forEach>
</table>
...
<br>
<input type="button" id="myInputEdit" class="button_active" onclick="location.href='${pageContext.request.contextPath}/admincreate';" value="Inserir Pessoa" />
<br>
